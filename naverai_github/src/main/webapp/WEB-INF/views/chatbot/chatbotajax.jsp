			...
			success:function(server){
				...
				for(var i=0; i < bubbles.length; i++){
					if(bubbles[i].type == 'text'){
						//텍스트답변.
						$("#chat").append("<p><span style='background-color:pink'> 답변 : " + server.bubbles[0].data.description +"</span></p>");
						...
						if(bubbles[i].data.cover.data.imageUrl != null){
							//이미지답변.
							$("#chat").append("<img src=" + bubbles[i].data.cover.data.imageUrl + " width=200 height=200><br>");
						}//이미지답변.
						else if(bubbles[i].data.cover.type == 'text'){
							$("#chat").append("<p><span style='background-color:pink'> 답변 : " + server.bubbles[0].data.cover.data.description +"</span></p>");
...
<body>
<div id="chat" width=500 height=500 style="border : 2px solid blue"> 여기에 대화 내용을 표시합니다.<br></div>
